...
public  class DatabaseService {
	...
	public void insertUser(User user){
		bd.insertUser(new User(user.getFirstName(),user.getLastName(),user.getUserName(),user.getEmail(),
				PasswordEncrypter.generateHashedPassword (user.getPassword(),""),user.getAdress(),user.getLevel()));
	}
	...
	public void updateUser(User user){
		bd.updateUser(new User(user.getId(),user.getFirstName(),user.getLastName(),user.getUserName(),user.getEmail(),
				PasswordEncrypter.generateHashedPassword (user.getPassword(),""),user.getAdress(),user.getLevel()));
	}
}
